 ...
 * //将图像点反投影到z轴坐标为1的相机坐标系中,并对三维点进行畸变矫正，返回矫正后的三维点
 *
 * \param p image coordinates
...
{
    //mx_d, my_d指的在相机坐标系中的点的坐标
    double mx_d, my_d,mx2_d, mxy_d, my2_d, mx_u, my_u;
    double rho2_d, rho4_d, radDist_d, Dx_d, Dy_d, inv_denom_d;
    //double lambda;

    // Lift points to normalised plane(即相机坐标系中的z坐标为1)
    //p(0) = fx*mx_d+cx;p(1) = fy*my_d+cy
 ...
 * 同时考虑了径向和切向畸变，参见此博客https://www.cnblogs.com/yuanlibin/p/8509865.html
 *
